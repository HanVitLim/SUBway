...
const TTSButtonKo = ({ text, transdata }) => {
  ...
  return(
    <div>
      <Button component="label" variant="contained" onClick={() => handleTTS_kor(transdata)}>{transdata} 읽기</Button>
    </div>
  )
};

export default TTSButtonKo;
